...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(PagosApiException.class)
    public ResponseEntity<GeneralResponseDTO<Object>> handle(PagosApiException ex) {
        ServerApiStatusCode c = ex.getStatusCode();
        log.warn("PagosApiException [{}]: {}", c.getCodigo(), ex.getMessage());
