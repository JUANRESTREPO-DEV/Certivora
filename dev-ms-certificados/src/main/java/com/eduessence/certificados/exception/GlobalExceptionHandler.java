...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(CertificadosApiException.class)
    public ResponseEntity<GeneralResponseDTO<Object>> handle(CertificadosApiException ex) {
        ServerApiStatusCode c = ex.getStatusCode();
        log.warn("CertificadosApiException [{}]: {}", c.getCodigo(), ex.getMessage());
